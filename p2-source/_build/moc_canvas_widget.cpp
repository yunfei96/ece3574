/****************************************************************************
** Meta object code from reading C++ file 'canvas_widget.hpp'
**
...
#error "The header file 'canvas_widget.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 10), // "addGraphic"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 14), // "QGraphicsItem*"
QT_MOC_LITERAL(4, 40, 4) // "item"

    },
    "CanvasWidget\0addGraphic\0\0QGraphicsItem*\0"
    "item"
};
...
void CanvasWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addGraphic((*reinterpret_cast< QGraphicsItem*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
